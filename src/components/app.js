...
class App extends Component {
  ...
  render() {
    ...
    const aboutBeans = {
      ...
      secondText:
        "Afraid at highly months do things on at. Situation recommend objection do intention so questions. As greatly removed calling pleased improve an. Last ask him cold feelmet spot shy want. Children me laughing we prospect answered followed. At it wentis song that held help face.",
    };
      ...
      <div className="app">
        <Routes>
          <Route path={process.env.PUBLIC_URL + "/"} element={<Layout />}>
            ...
            <Route
              path="pleasure"
              element={<Pleasure data={data} info={aboutGoods} />}
            />
          </Route>
        </Routes>
      </div>
