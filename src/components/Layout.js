      ...
      <div id="wrap">
        <div className={className}>
          <div className="nav-list">
            ...
            <NavLink className="nav-item" to="pleasure">
              For your pleasure
            </NavLink>
          </div>
        ...
        <div className="footer">
          <div className="footer__nav-list">
            ...
            <NavLink className="footer__nav-item" to="/">
              Coffee house
            </NavLink>
            <NavLink className="footer__nav-item" to="shop">
              Our coffee
            </NavLink>
            <NavLink className="footer__nav-item" to="pleasure">
              For your pleasure
            </NavLink>
          </div>
          <img
